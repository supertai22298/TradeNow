...
<section class="content">
  <div class="card card-success">
      ...
      <div class="card-body">
          ...
          <form id="newProductForm" onsubmit="return confirm('Lưu ý nếu xác nhận chỉnh sửa thì sản phẩm của bạn sẽ được kiếm duyệt lại.')" method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="tab">
              <p>
                ...
                <div class="productDetail">
                  ...
                  <p class="d-inline-block col-md-5">
                    ...
                    <input type="text" 
                      ...
                      name="detail_description[]" value="{{ $product_detail->description }}" 
            ...
            <div class="tab">
              <p>
                ...
                <input name="title_seo" 
                  value="{{ $product->title_seo }}" type="text" 
              ...
              <p>
                ...
                <textarea id="description_seo"  
                  ...
                  >{{ $product->description_seo }}</textarea>
            ...
            <div style="overflow:auto;">
              <div style="float:right;">
                ...
                <a class="btn btn-flat btn-secondary mr-4" href="{{ route('admin.products.index') }}"><i class="fas fa-arrow-left" aria-hidden="true"></i> Danh sách</a>
