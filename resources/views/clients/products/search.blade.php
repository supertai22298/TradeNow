...
<div class="main-container container">
  <ul class="breadcrumb">
    ...
    <li><a href="/"><i class="fa fa-home"></i>Tìm kiếm</a></li>
  </ul>
  <div class="row">
    <!--Left Part Start -->
    <aside class="col-sm-4 col-md-3" id="column-left">
      <div class="module block-shopby titleLine">
        <h3 class="modtitle"><span>Tìm kiếm</span></h3>
                ...
                <div class="table_cell" style="z-index: 103;">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-btn">
                      <button class="btn btn-default inverse" type="button" id="submit_text_search"><i
                ...
                <div class="table_cell">
                  <fieldset>
                    ...
                    <div class="range">
                      ...
                      <input type="hidden" name="" class="max_value" value="10000000">
                    </div>
        ...
        <div class="modcontent ">
          ...
          <div class="product-latest-item">
            <div class="media">
              ...
              <a href="{{ route('client.products.show', $item->id)}}"><img src="{{ asset('images/' . $item->image)}}" alt="{{$item->name}}" title="{{$item->name}}"
                    class="img-responsive" style="width: 90px; height: 90px;"></a>
              </div>
              <div class="media-body">
                ...
                <h4><a href="{{ route('client.products.show', $item->id)}}">{{$item->name}}</a></h4>
                  ...
                  <div class="price">
                    <span class="price-new">{{ 'đ' . number_format($item->price, 0,'', '.')}}</span>
                  </div>
                  <div class="ratings">
      ...
      <div class="products-category">
        ...
        <div class="products-list row list">
          @if ($products->count() > 0)
            ...
            <div class="product-layout  col-md-3 col-sm-6 col-xs-12">
              <div class="product-item-container">
                ...
                <div class="button-group">
                  @if (Auth::check())
                  <button class="wishlist btn-button {{$item->hasWishList()}}" data-id="{{$item->id}}" type="button"
                    data-toggle="tooltip" title="Add to Wish List"><i class="fa fa-heart"></i></button>
                  @endif
                  <button data-id={{ $item->id }} class="addToCart" type="button" data-toggle="tooltip"
                    title="Thêm vào giỏ"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs name-cart">Thêm vào
                      giỏ</span></button>
            ...
            @endforeach
          @else 
            <h1 style="margin-left: 50px">Không có kết quả</h1>
          @endif
        </div>
