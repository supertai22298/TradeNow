    ...
    <div>
      ...
      <ul class="nav nav-tabs">
        <li role="presentation" class="active">
          <a style="font-weight: 600;" href="#all-tab" id="all-tab-button" data-toggle="pill" role="tab" aria-controls="all-tab" aria-selected="true">Tất cả</a>
        </li>
        <li role="presentation">
          <a style="font-weight: 600;" href="#delivering-tab" id="delivering-tab-button" data-toggle="pill" role="tab" aria-controls="delivering-tab" aria-selected="true">Đang giao</a>
        </li>
        <li role="presentation">
          <a style="font-weight: 600;" href="#delivered-tab" id="delivered-tab-button" data-toggle="pill" role="tab" aria-controls="delivered-tab" aria-selected="true">Đã giao</a>
        </li>
        <li role="presentation">
          <a style="font-weight: 600;" href="#cancelled-tab" id="cancelled-tab-button" data-toggle="pill" role="tab" aria-controls="cancelled-tab" aria-selected="true">Đã hủy</a>
        </li>
      </ul>
    </div>
        ...
        <div class="container row">
          @foreach ($orders as $order)
            <div class="row">
              ...
              <div class="col-md-8">
                <h3 style="margin-top: 5px;">{{$order->name}}</h3>
