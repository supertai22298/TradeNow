        ...
        <div class="product-layout col-md-3 col-sm-3 col-xs-12">
          <div class="product-item-container">
            ...
            <div class="button-group row">
              ...
              <button class="col-md-4 btn btn-default" type="button" title="Thêm vào giỏ hàng"><i
        ...
        <div class="product-layout col-md-9 col-sm-9 col-xs-12" style="padding-top: 20px;">
          <div class="product-item-container">
            <div class="right-block">
              <div class="caption">
                <h2><a
                    href="{{route('client.products.show',$wish_list->product_id)}}">{{ $wish_list->product->name }}</a>
                </h2>
                <div class="ratings">
                  <div class="rating-box">
                    @for ($i = 0; $i < 5; $i++) <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i
