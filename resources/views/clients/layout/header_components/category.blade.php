                ...
                <ul class="megamenu">
                  <li class="item-vertical style1 with-sub-menu hover">
                    ...
                    <a href="#" class="clearfix">
                      <img src="clients/image/theme/icons/icon1.png" alt="icon">
                      <strong>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4">
                            <div class="row img-banner">
                              <a href="#"><img src="clients/image/demo/cms/img-static-megamenu-h.png" alt="banner"></a>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <li class="item-vertical">
                    <p class="close-menu"></p>
                    <a href="#" class="clearfix">
                      <img src="clients/image/theme/icons/icon2.png" alt="icon">
                      <strong>
                  ...
                  <li class="item-vertical with-sub-menu hover">
                    <p class="close-menu"></p>
                    <a href="#" class="clearfix">
                      <img src="clients/image/theme/icons/icon3.png" alt="icon">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="row banner">
                              <a href="#">
                                <img src="clients/image/demo/cms/menu_bg2.jpg" alt="banner1">
                                </a>
                              </div>
                            </div>
                          </div>
                    ...
                    <li class="item-vertical with-sub-menu hover">
                      <p class="close-menu"></p>
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon4.png" alt="icon">
                        <strong>
                    ...
                    <li class="item-vertical css-menu with-sub-menu hover">
                      <p class="close-menu"></p>
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon5.png" alt="icon">
                        <strong>
                    ...
                    <li class="item-vertical">
                      <p class="close-menu"></p>
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon6.png" alt="icon">
                        <strong>
                    ...
                    <li class="item-vertical">
                      <p class="close-menu"></p>
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon7.png" alt="icon">
                        <strong>
                    ...
                    <li class="item-vertical" style="display: none;">
                      ...
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon8.png" alt="icon">
                        <strong>
                    ...
                    <li class="item-vertical" >
                      <p class="close-menu"></p>
                      <a href="#" class="clearfix">
                        <img src="clients/image/theme/icons/icon9.png" alt="icon">
                        <strong>
